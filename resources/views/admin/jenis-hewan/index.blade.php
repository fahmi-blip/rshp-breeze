  ...
  <nav class="flex mb-6" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      <li class="inline-flex items-center">
        {{-- <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center font-medium text-gray-700 text-theme-sm hover:text-brand-500"> --}}
      ...
      <li>
        <div class="flex items-center">
          ...
          <span class="ml-1 font-medium text-gray-400 text-theme-sm md:ml-2" x-text="pageName"></span>
        </div>
      </li>
    </ol>
  </nav>
...
<div class="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
  <div class="flex items-center justify-between mb-6">
    <h2 class="font-semibold text-gray-900 text-title-md">Daftar Jenis Hewan</h2>
          ...
          <td class="px-6 py-4">
            <div class="flex items-center gap-2">
              {{-- <a href="{{ route('admin.jenis-hewan.edit', $hewan->idjenis_hewan) }}"  --}}
                 class="inline-flex items-center gap-1 px-3 py-2 text-xs font-medium text-white rounded-lg bg-success-500 hover:bg-success-600">
              ...
              {{-- <form action="{{ route('admin.jenis-hewan.destroy', $hewan->idjenis_hewan) }}" method="POST" class="inline"> --}}
                ...
                <button type="submit" 
                        ...
                        class="inline-flex items-center gap-1 px-3 py-2 text-xs font-medium text-white rounded-lg bg-error-500 hover:bg-error-600">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
