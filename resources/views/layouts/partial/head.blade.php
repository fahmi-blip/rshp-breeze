...
<!-- sidenav  -->
    <aside
      ...
      <div class="h-19.5">
        ...
        <a
          ...
          {{-- <img
            ...
            alt="main_logo" /> --}}
          <span
            class="ml-1 duration-200 wid widtransition-all -semibold font ease-nav-brand"
            >RSHP</span
          >
        </a>
      </div>
      ...
      <div
        class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full ps">
