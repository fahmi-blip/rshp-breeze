        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    ...
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 
                        {{ $active ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' }}">
                        {{-- Icon Dashboard (Warna Putih jika Aktif, Hitam/Slate jika Tidak) --}}
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="{{ $active ? '#FFFFFF' : '#344767' }}" fill-rule="nonzero">
            ...
            <!-- Tables -->
            @php
                $active = request()->routeIs('admin.jenis-hewan.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
            ...
            <!-- Billing -->
            @php
                $active = request()->routeIs('admin.pemilik.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
             ...
             @php
                $active = request()->routeIs('admin.ras-hewan.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
             ...
             @php
                $active = request()->routeIs('admin.kategori.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
             ...
             @php
                $active = request()->routeIs('admin.kategori-klinis.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
             ...
             @php
                $active = request()->routeIs('admin.tindakan-terapi.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    href="{{ route('admin.tindakan-terapi.index') }}">
            ...
            <li class="mt-0.5 w-full">
             ...
             @php
                $active = request()->routeIs('admin.pet.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
             ...
             @php
                $active = request()->routeIs('admin.role-user.index');
            @endphp
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
            ...
            @if(Auth::user()->hasRole('resepsionis'))
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors {{ request()->routeIs('resepsionis.registrasi.pemilik') ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" href="{{ route('resepsionis.registrasi.pemilik') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5  bg-gradient-to-tl from-blue-600 to-cyan-400">
                            <svg
                            width="10px"
                            height="10px"
                            viewBox="0 0 40 44"
