    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            @if(Auth::user()->hasRole('resepsionis'))
                ...
                @php
                $active = request()->routeIs('resepsionis.dashboard');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    ...
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 
                        {{ $active ? 'bg-gradient-to-tl from-blue-600 to-cyan-400' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg"> 
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="{{ $active ? '#FFFFFF' : '#344767' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                ...
                @php
                $active = request()->routeIs('resepsionis.registrasi.pemilik');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    href="{{ route('resepsionis.registrasi.pemilik') }}">
                ...
                @php
                $active = request()->routeIs('resepsionis.registrasi.index_pet');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    href="{{ route('resepsionis.registrasi.index_pet') }}">
                ...
                @php
                $active = request()->routeIs('resepsionis.registrasi.temudokter');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    href="{{ route('resepsionis.registrasi.temudokter') }}">
            ...
            @if(Auth::user()->hasRole('dokter'))
                ...
                <li class="mt-0.5 w-full">
                    ...
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 
                        {{ $active ? 'bg-gradient-to-tl from-green-600 to-lime-400' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg"> 
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="{{ $active ? '#FFFFFF' : '#344767' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                 ...
                 @php
                $active = request()->routeIs('dokter.detail-rekam-medis.index');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
                    href="{{ route('dokter.detail-rekam-medis.index') }}">
...
{{-- ... Lanjutan kode sidebar ... --}}
            ...
            @if(Auth::user()->hasRole('perawat'))
                ...
                @php
                $active = request()->routeIs('perawat.rekam-medis.index');
                @endphp
                <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors 
                    {{ $active ? 'shadow-soft-xl bg-white font-semibold text-slate-700' : 'text-slate-500 hover:text-slate-700' }}" 
